...
const Contact = () => {
  return (
    <section className="bg-[#fcf7ee] text-[#252525] min-h-screen">
      <div className="max-w-7xl mx-auto px-6 sm:px-10 lg:px-16 py-12 sm:py-14 w-full">
        {/* Section Header */}
        ...
        <div>
          ...
          {/* Contact Info — PERFECTLY CENTERED */}
          <div className="max-w-4xl mx-auto mt-12">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-10 text-center">
              <div className="flex flex-col items-center justify-center">
                <p className="text-xs tracking-widest uppercase text-[#025559] mb-3">
                  Location
                </p>
